 ...
 */
export const BAN_API_BASE = process.env.BAN_API_BASE || "https://api-adresse.data.gouv.fr";
export const DVF_API_BASE = process.env.DVF_API_BASE || "https://api.cquest.org/dvf";
